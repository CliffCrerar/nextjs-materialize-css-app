  ...
  render() {
    return (
      <style jsx global>{`
        @import "static/scss/_1_components.scss";
        :root {
          --dark-primary: ${this.state.theme[
            "dark-primary-color"
          ]}; /* DARK PRIMARY */
          --default-primary: ${this.state.theme[
            "default-primary-color"
          ]}; /* LIGHT PRIMARY */
          --light-primary: ${this.state.theme[
            "light-primary-color"
          ]}; /* PRIMARY */
          --text-primary: ${this.state.theme[
            "text-primary-color"
          ]}; /* TEXT ICONS */
          --accent: ${this.state.theme["accent-color"]}; /* ACCENT */
          --primary-text: ${this.state.theme[
            "primary-text-color"
          ]}; /* PRIMARY TEXT */
          --secondary-text: ${this.state.theme[
        ...
        .nav-wrapper a {
          color: var(
            ${this.state.darkNavText ? "--primary-text" : "--text-primary"}
          );
        }
      `}</style>
    );
